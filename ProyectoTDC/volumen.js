const icon = document.querySelector("#icon"),
      ...
      const volume30Icon = ` <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-volume-off-fill" viewBox="0 0 16 16">
      ...
      const volume70icon = ` <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-volume-down-fill" viewBox="0 0 16 16">
...
range.addEventListener("input", () => {
    ...
    if (rangeVal > 0) {
        icon.innerHTML = volumeUpIcon;
    } else {
        icon.innerHTML = muteIcon;
    }
    if (rangeVal > 1) {
      icon.innerHTML = volume70icon;
  } else {
      icon.innerHTML = muteIcon;
  }
  if (rangeVal > 70) {
